...
public:
    ...
    {
        AsynchronousGrabGui->setWindowTitle(QCoreApplication::translate("AsynchronousGrabGui", "Vmb C AsynchronousGrab", nullptr));
        m_renderLabel->setText(QString());
        m_acquisitionStartStopButton->setText(QCoreApplication::translate("AsynchronousGrabGui", "Start Acquisition", nullptr));
    } // retranslateUi
