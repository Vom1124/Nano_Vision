...
#include "../../../../src/VimbaX_2023-1/api/examples/VmbC/AsynchronousGrabQt/UI/ImageLabel.h"
...
QT_MOC_LITERAL(3, 24, 5) // "value"
    ...
    "ImageLabel\0sizeChanged\0\0value"
};
...
void ImageLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ImageLabel::*)(QSize );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLabel::sizeChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageLabel::sizeChanged(QSize _t1)
{
